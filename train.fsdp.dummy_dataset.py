...
# -- Set up training set
# [LEARN] Dummy dataset is used for testing model runtime efficiency
input_config = dataset_config.get('input')
C            = input_config.get('C')
H            = input_config.get('H')
W            = input_config.get('W')
total_size   = input_config.get('total_size')
